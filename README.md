[intro.html](https://github.com/user-attachments/files/24430502/intro.html)
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
...
/* 뒷면 */
.envelope-back {
  transform: rotateY(180deg); /* ⭐ 반대 방향 */
  background: #fffdf5;
  display: flex;
...
.back-content p {
  margin-top: 0px;
  margin-bottom: 6px;   /* 기본값은 보통 16px 이상 */
}
  ...
  <div class="envelope-3d">
    ...
    <div class="envelope-back">
      ...
      <div class="back-content">
        <p>🔒<br>이 편지를 열려면<br>비밀번호가 필요해요</p>
        <input id="pw" type="password" />
        <button id="pwBtn">편지 열기</button>
      </div>
    </div>
